...
'''
    This is just for testing Neo4j connections!
    This is not integrated into the Django app.
'''


driver = GraphDatabase.driver("bolt://0.0.0.0:7687", auth=("neo4j", "contactbook"), encrypted=False)
...
with driver.session() as session:
    ...
    session.read_transaction(print_contacts, "Arthur")
